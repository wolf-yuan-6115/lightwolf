...
#define EQ_PROTOCOL_AUDIO_CONTROLS_PAYLOAD_SIZE 9u
#define EQ_PROTOCOL_CROSSFEED_PAYLOAD_SIZE 8u
#define EQ_PROTOCOL_CROSSFEED_STATE_PAYLOAD_SIZE 17u
#define EQ_PROTOCOL_OUTPUT_PROCESSING_PAYLOAD_SIZE 8u
#define EQ_PROTOCOL_OUTPUT_PROCESSING_STATE_PAYLOAD_SIZE 17u
#define EQ_PROTOCOL_GLOBAL_PAYLOAD_SIZE 8u
#define EQ_PROTOCOL_BAND_PAYLOAD_SIZE 21u
#define EQ_PROTOCOL_STATUS_PAYLOAD_SIZE 48u
#define EQ_PROTOCOL_METER_CONFIG_PAYLOAD_SIZE 4u
#define EQ_PROTOCOL_METER_LEVEL_PAYLOAD_SIZE 32u
#define EQ_PROTOCOL_METER_FLAG_LIMITER_ACTIVE 0x01u
...
typedef enum {
  ...
  EQ_OPCODE_GET_AUDIO_CONTROLS = 0x06,
  EQ_OPCODE_GET_CROSSFEED = 0x07,
  EQ_OPCODE_GET_OUTPUT_PROCESSING = 0x08,
  EQ_OPCODE_SET_CROSSFEED = 0x12,
  EQ_OPCODE_SET_OUTPUT_PROCESSING = 0x13,
  EQ_OPCODE_SAVE_CROSSFEED = 0x26,
  EQ_OPCODE_SAVE_OUTPUT_PROCESSING = 0x27,
